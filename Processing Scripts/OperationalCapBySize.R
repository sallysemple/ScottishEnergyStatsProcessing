...
REPD <- REPD %>% 
  ...
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Large Hydro", "Hydro")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Small Hydro", "Hydro")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Biomass (co-firing)", "Biomass and Waste")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "EfW Incineration", "Biomass and Waste")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Biomass (dedicated)", "Biomass and Waste")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Advanced Conversion Technologies", "Biomass and Waste")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Anaerobic Digestion", "Biomass and Waste")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Landfill Gas", "Biomass and Waste")) %>% 
  mutate(`Technology Type` = replace(`Technology Type`, `Technology Type` == "Sewage Sludge Digestion", "Biomass and Waste")) 
